    ...
    <div className="relative h-[70vh] bg-cover z-0">
      ...
      <div className="absolute top-0 left-0 z-30 text-white mx-8 md:mx-16 lg:mx-16 flex flex-col h-full justify-center w-[80vw] md:w-[70vw] lg:w-[50vw]">
        ...
        <p className="text-2xl md:text-3xl lg:text-3xl my-6">
          ...
          <p className="text-2xl md:text-3xl lg:text-4xl text-orange-600">
          Technically co-sponsored by
      </p>
          <p className="text-2xl md:text-3xl lg:text-4xl my-6 text-orange-600"><span className="font-bold"> IEEE </span>Madras Section</p>
        <p className="text-xl md:text-2xl lg:text-3xl my-6">

        ...
        <div className="text-white p-4 overflow-x-auto">
            <table className="w-full border-collapse table-auto bg-[#111042]">
                ...
                <tr>
                    ...
                    <th className="border border-white py-2 px-4 text-red-600">*Registration fee includes GST</th>
                ...
                <tr>
                    ...
                    <td className="border border-white py-2 px-4 text-center">Rs. 12000</td>
